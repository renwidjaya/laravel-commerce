            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a href="{{url('admin/delete/user/'.$user->id)}}" class="btn btn-sm btn-secondary waves-effect waves-light confirm" data-my-message="{{__('admin_pages.are_u_sure_delete_u')}}">{{__('admin_pages.delete_user')}}</a>
                    </td>
                </tr> 
                @endforeach
            </tbody>
