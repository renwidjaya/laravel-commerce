                        ...
                        <td colspan="6">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endphp
                                    <div class="product">
                                        <a href="{{ url($producta->url) }}" target="_blank">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $fOrder->names }}</td>
                                    <td class="text-right">
                                        <a href="{{ url('admin/fast/ord/is/viewed/'.$fOrder->id) }}" class="btn btn-sm btn-secondary confirm" data-my-message="{{__('admin_pages.are_u_sure_mark_fOrd')}}">
