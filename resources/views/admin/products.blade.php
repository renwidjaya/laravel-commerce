        ...
        <div class="card card-cascade narrower hm-zoom"> 
            ...
            <div class="card-body text-center no-padding">
                ...
                <div class="card-footer">
                    ...
                    <span class="right">
                        <a href="{{ url('admin/edit/pruduct/'.$product->id) }}" class="btn btn-secondary btn-sm">
                            {{__('admin_pages.edit')}}
                        </a>
                        <a href="{{ url('admin/delete/product/'.$product->id) }}" data-my-message="{{__('admin_pages.are_u_sure_delete')}}" class="btn btn-secondary btn-sm confirm">
