...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-3 col-md-3 col-lg-2 left-side">
                            ...
                            <ul class="nav">
                                <li>
                                    <a href="{{ url('admin') }}" class="btn waves-effect waves-light">
                                        <p>{{__('admin_pages.dashboard')}}</p>
                                    </a> 
                                </li>
                                <li>
                                    <a href="{{ url('admin/publish') }}" class="btn waves-effect waves-light">
                                        <p>{{__('admin_pages.publish')}}</p>
                                    </a> 
                                </li>
                                <li>
                                    <a href="{{ url('admin/products') }}" class="btn waves-effect waves-light">
                                        <p>{{__('admin_pages.products')}}</p>
                                    </a> 
                                </li> 
                                <li>
                                    <a href="{{ url('admin/categories') }}" class="btn waves-effect waves-light">
                                        
                                        <p>{{__('admin_pages.categories')}}</p>
                                    </a> 
                                </li>
                                <li>
                                    <a href="{{ url('admin/orders') }}" class="btn waves-effect waves-light">
                                        
                                        <p>{{__('admin_pages.orders')}}</p>
                                    </a> 
                                </li>
                                <li>
                                    <a href="{{ url('admin/users') }}" class="btn waves-effect waves-light">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10 col-sm-offset-3 col-md-offset-3 col-lg-offset-2 right-side">
                            <nav class="navbar">
                                ...
                                <div id="navbar" class="collapse navbar-collapse"> 
                                    ...
                                    <form class="navbar-form navbar-right nav-bar-search" action="{{url('admin/products')}}" role="search">
                ...
                <div class="row"> 
                    <div class="col-sm-9 col-md-9 col-lg-10 col-sm-offset-3 col-md-offset-3 col-lg-offset-2">
                        <ul class="nav">
                            ...
                            <li class="in-right">
                                <a href="https://www.temanrendy.com" target="_blank">
                                    temanrendy.com
                                </a>
                            </li>
                        </ul>
        ...
        var urls = {
            ...
            editCategory: "{{ url('admin/categories') }}",
            deleteCategories: "{{ url('admin/delete/categories') }}",
            changeStatus: "{{ url('admin/changeOrderStatus') }}"
        };
        var langs = {
