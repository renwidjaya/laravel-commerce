...
class ProductsCategoryController extends Controller
{
    ...
    public function setCategory(Request $request)
    {
        ...
        return redirect(url('admin/categories'))->with(['msg' => $result['msg'], 'result' => $result['result']]);
    }
    ...
    public function deleteCategories(Request $request)
    {
        ...
        return redirect(url('admin/categories'))->with(['msg' => Lang::get('admin_pages.selected_categ_deleted'), 'result' => true]);
    }
